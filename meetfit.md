...
![TRAINERIZE.me](https://file.trainerize.com/assets/tzme/images/tz-me-logo-white.png)
  Сайт широко известен, попадает в поисковые выдачи при почти всех видах запросов, поэтому на него возлагались большие надежды как на источние получения выверенного и удобного пользовательского опыта. В реальности, автору не удалось назначить интервью с тренером после нескольких дней безуспешных попыток. Первая странца сайта грамотно разделяет входной поток посетителей на тренеров и фитнес-энтузиастов (терминология создалей сайта). Так как цель исследование - получение опыта в качестве обучаемого, то был выбран соответствующий раздел. 
